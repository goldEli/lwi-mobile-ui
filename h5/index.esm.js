import React, { createRef, createElement, Component } from 'react';
...
var _defineProperty$1 = /*@__PURE__*/unwrapExports(defineProperty$1);
...
var _slicedToArray = /*@__PURE__*/unwrapExports(slicedToArray);
...
var _typeof = /*@__PURE__*/unwrapExports(_typeof_1);
...
var _toConsumableArray = /*@__PURE__*/unwrapExports(toConsumableArray);
...
var reactifyWebComponent = function reactifyWebComponent(WC) {
  ...
  return /*#__PURE__*/React.forwardRef(function (props, ref) {
    return /*#__PURE__*/React.createElement(Index, _objectSpread$1(_objectSpread$1({}, props), {}, {
      forwardRef: ref
    }));
  });
};
...
var Input$1 = reactifyWebComponent('taro-input-core'); // eslint-disable-next-line

React.createElement;
var ReactInput = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/React.createElement(Input$1, _objectSpread(_objectSpread({}, args), {}, {
    ref: ref
  }));
});

var View = reactifyWebComponent('taro-view-core');
reactifyWebComponent('taro-icon-core');
reactifyWebComponent('taro-progress-core');
reactifyWebComponent('taro-rich-text-core');
var Text = reactifyWebComponent('taro-text-core');
var Button = reactifyWebComponent('taro-button-core');
reactifyWebComponent('taro-checkbox-core');
reactifyWebComponent('taro-checkbox-group-core');
reactifyWebComponent('taro-editor-core');
var Form = reactifyWebComponent('taro-form-core');
var Input = ReactInput;
var Label = reactifyWebComponent('taro-label-core');
var Picker = reactifyWebComponent('taro-picker-core');
reactifyWebComponent('taro-picker-view-core');
reactifyWebComponent('taro-picker-view-column-core');
reactifyWebComponent('taro-radio-core');
reactifyWebComponent('taro-radio-group-core');
var Slider = reactifyWebComponent('taro-slider-core');
var Switch = reactifyWebComponent('taro-switch-core');
reactifyWebComponent('taro-cover-image-core');
var Textarea = reactifyWebComponent('taro-textarea-core');
reactifyWebComponent('taro-cover-view-core');
var MovableArea = reactifyWebComponent('taro-movable-area-core');
var MovableView = reactifyWebComponent('taro-movable-view-core');
var ScrollView = reactifyWebComponent('taro-scroll-view-core');
var Swiper = reactifyWebComponent('taro-swiper-core');
var SwiperItem = reactifyWebComponent('taro-swiper-item-core');
reactifyWebComponent('taro-functional-page-navigator-core');
reactifyWebComponent('taro-navigator-core');
reactifyWebComponent('taro-audio-core');
reactifyWebComponent('taro-camera-core');
var Image = reactifyWebComponent('taro-image-core');
reactifyWebComponent('taro-live-player-core');
reactifyWebComponent('taro-video-core');
reactifyWebComponent('taro-map-core');
reactifyWebComponent('taro-canvas-core');
reactifyWebComponent('taro-ad-core');
reactifyWebComponent('taro-official-account-core');
var OpenData = reactifyWebComponent('taro-open-data-core');
reactifyWebComponent('taro-web-view-core');
reactifyWebComponent('taro-navigation-bar-core');
reactifyWebComponent('taro-block-core');
reactifyWebComponent('taro-custom-wrapper-core');

var BlankComponents = function (props) {
...
var AtButton = /** @class */ (function (_super) {
    ...
    AtButton.prototype.render = function () {
        ...
        var webButton = (React.createElement(Button, { className: 'at-button__wxbutton', lang: lang, formType: formType }));
    ...
    AtCard.prototype.render = function () {
        ...
        return (React.createElement(View, { onClick: this.handleClick, className: rootClass },
            React.createElement(View, { className: 'at-card__header' },
                ...
                extra && (React.createElement(Text, { style: __assign({}, extraStyle), className: 'at-card__header-extra' }, extra))),
...
var AtCheckbox = /** @class */ (function (_super) {
    ...
    AtCheckbox.prototype.render = function () {
        ...
        return (React.createElement(View, { className: rootCls, style: customStyle }, options.map(function (option, idx) {
            ...
            return (React.createElement(View, { className: optionCls, key: value, onClick: _this.handleClick.bind(_this, idx) },
...
var AtDrawer = /** @class */ (function (_super) {
    ...
    AtDrawer.prototype.render = function () {
        ...
        return _show ? (React.createElement(View, { className: classnames(rootClassName, classObject, this.props.className) },
            ...
            React.createElement(View, { className: 'at-drawer__content', style: listStyle }, !!items && items.length ? (React.createElement(AtList, null, items.map(function (name, index) { return (React.createElement(AtListItem, { key: name + "-" + index, "data-index": index, onClick: _this.onItemClick.bind(_this, index), title: name, arrow: 'right' })); }))) : (this.props.children)))) : (React.createElement(View, null));
    };
    return AtDrawer;
}(React.Component));
...
var AtGrid = /** @class */ (function (_super) {
    ...
    AtGrid.prototype.render = function () {
        ...
        return (React.createElement(View, { className: classnames('at-grid', this.props.className) }, gridGroup.map(function (item, i) { return (React.createElement(View, { className: 'at-grid__flex', key: "at-grid-group-" + i }, item.map(function (childItem, index) {
            var _a;
            return (React.createElement(View, { key: "at-grid-item-" + index, className: classnames(bodyClass, {
...
var AtRadio = /** @class */ (function (_super) {
    ...
    AtRadio.prototype.render = function () {
        ...
        return (React.createElement(View, { className: classnames('at-radio', className), style: customStyle }, options.map(function (option) { return (React.createElement(View, { key: option.value, onClick: _this.handleClick.bind(_this, option), className: classnames({
...
var AtRate = /** @class */ (function (_super) {
    ...
    AtRate.prototype.render = function () {
        ...
        return (React.createElement(View, { className: classnames('at-rate', className), style: customStyle }, classNameArr.map(function (cls, i) { return (React.createElement(View, { className: cls, key: "at-rate-star-" + i, style: iconStyle, onClick: _this.handleClick.bind(_this, i + 1) },
...
var AtSegmentedControl = /** @class */ (function (_super) {
    ...
    AtSegmentedControl.prototype.render = function () {
        ...
        return (React.createElement(View, { className: rootCls, style: mergeStyle(rootStyle, customStyle) }, values.map(function (value, i) { return (React.createElement(View, { className: classnames('at-segmented-control__item', {
            ...
            return (React.createElement(View, { className: classnames('at-tab-bar__item', {
                ...
                item.iconType ? (React.createElement(AtBadge, { dot: !!item.dot, value: item.text, maxValue: Number(item.max) },
                    React.createElement(View, { className: 'at-tab-bar__icon' },
                        React.createElement(Text, { className: classnames("" + (item.iconPrefixClass || 'at-icon'), (_a = {},
        ...
        var itemElems = items.map(function (item, index) {
            ...
            return (React.createElement(View, { className: classnames(itemRootClassName), key: "at-timeline-item-" + index },
                ...
                React.createElement(View, { className: 'at-timeline-item__content' },
                    ...
                    content.map(function (sub, subIndex) { return (React.createElement(View, { className: 'at-timeline-item__content-item at-timeline-item__content--sub', key: subIndex }, sub)); }))));
        });
    ...
    AtSteps.prototype.render = function () {
        ...
        return (React.createElement(View, { className: classnames('at-steps', className), style: customStyle }, !!items &&
            items.map(function (item, i) {
                var _a;
                return (React.createElement(View, { key: item.title, className: classnames({
                        'at-steps__item': true,
...
var AtIndexes = /** @class */ (function (_super) {
    ...
    AtIndexes.prototype.render = function () {
        ...
        var indexesList = list.map(function (dataList) { return (React.createElement(View, { id: "at-indexes__list-" + dataList.key, className: 'at-indexes__list', key: dataList.key },
...
var AtCalendarList = /** @class */ (function (_super) {
    ...
    AtCalendarList.prototype.render = function () {
        ...
        if (!list || list.length === 0)
            return null;
        return (React.createElement(View, { className: 'at-calendar__list flex' }, list.map(function (item) { return (React.createElement(View, { key: "list-item-" + item.value, onClick: _this.handleClick.bind(_this, item), onLongPress: _this.handleLongClick.bind(_this, item), className: classnames('flex__item', "flex__item--" + MAP[item.type], {
...
var AtCalendarHeader = /** @class */ (function (_super) {
    ...
    AtCalendarHeader.prototype.render = function () {
        return (React.createElement(View, { className: 'at-calendar__header header' },
            React.createElement(View, { className: 'header__flex' },
            ...
            return (React.createElement(View, { className: classnames('main', 'at-calendar-slider__main', "at-calendar-slider__main--" + process.env.TARO_ENV) },
                ...
                React.createElement(View, { className: 'main__body body' },
                    React.createElement(View, { className: 'body__slider body__slider--now' },
                        React.createElement(AtCalendarList, { list: listGroup[1].list, onClick: this.props.onDayClick, onLongClick: this.props.onLongClick })))));
        }
            ...
            return (React.createElement(View, { className: classnames('main', 'at-calendar-slider__main', "at-calendar-slider__main--" + process.env.TARO_ENV), onTouchEnd: this.handleTouchEnd, onTouchMove: this.handleTouchMove, onTouchStart: this.handleTouchStart },
                ...
                React.createElement(View, { className: classnames('main__body  body', {
                    ...
                    React.createElement(View, { className: 'body__slider body__slider--pre' },
                        React.createElement(AtCalendarList, { list: listGroup[0].list })),
                    React.createElement(View, { className: 'body__slider body__slider--now' },
                        React.createElement(AtCalendarList, { list: listGroup[1].list, onClick: this.props.onDayClick, onLongClick: this.props.onLongClick })),
...
var TitleText = function (props) {
    ...
    return (React.createElement(View, { style: __assign$1(__assign$1({}, defaultStyle), { color: props.color, textAlign: props.align, lineHeight: props.lineHeight + "px", fontSize: props.fontSize + "px", fontWeight: props.fontWeight, padding: "0 " + props.paddingX + "px", height: props.height === undefined ? "100%" : props.height + "px" }) },
        props.text,
        React.createElement(AtButton, { type: "primary" }, "123")));
};
...
export { BlankComponents, TitleText };
